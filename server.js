...
app.post("/new-fuel-quote", async (req, res) => {
    ...
    await pool.query("INSERT INTO fuelquote (username, gallons_requested, delivery_address, delivery_date, suggested_price, total_amount) VALUES($1, $2, $3, $4, $5, $6)", [currentUser, req.body.gallonsRequested, userAddress, req.body.deliveryDate, 0, 0]);
